...
function Sobre() {
    return ( 
        <main>
            ...
            <section className="mt-32 h-[550px] px-[250px] gap-y-6 flex flex-col max-xl:text-center max-xl:items-center">
                ...
                <Barra tamanho="100%"/>
                <div className="flex w-full justify-between max-xl:flex-col max-xl:items-center max-xl:text-center max-xl:gap-y-10">
                    <img className="w-2/6 h-auto max-xl:w-2/4"  src="KoliaPretoQualidade.png" alt="" />
                    <div className="w-3/5 h-auto flex flex-col gap-y-7 max-xl:w-full">
            ...
            <section className="bg-gradient-to-b from-black to-[#252525] px-[250px] py-20 mt-24 max-xl:mt-96 ">
